...
namespace Ordering.AI.Extensions
{
            ...
            using (var scope = host.Services.CreateScope())
            {
                ...
                catch (SqlException ex)
                {
                    ...
                    if (retryForAvailability < 50)
                    {
                        ...
                        logger.LogInformation("Retrying migration of database used on context {DbContextName} - {RetryCount} time", typeof(TContext).Name, retryForAvailability);
